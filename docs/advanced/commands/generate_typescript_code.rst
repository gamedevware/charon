...
.. code-block:: bash
  ...
  charon GENERATE TYPESCRIPTCODE --dataBase "c:\my app\gamedata.json" --outputDirectory "c:\my app\scripts"

  # remote game data
  charon GENERATE TYPESCRIPTCODE --dataBase "https://charon.live/view/data/My_Game/develop/" --outputDirectory "./scripts" --credentials "<API-Key>"
...
- :doc:`Working with TypeScript Code <../../gamedata/source_code/type_script/working_with_type_script_code>`
