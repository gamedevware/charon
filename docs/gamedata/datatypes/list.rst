...
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Asset Path <sub/asset>`                         | A relative path to a single game asset.                         |
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Asset Path Collection <sub/asset_collection>`   | Multiple relative paths to game assets.                         |
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Vector 2/3/4 <sub/vector>`                      | A group of 2, 3, or 4 decimal values (e.g., position or scale). |
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Integer Vector 2/3/4 <sub/vector_int>`          | A group of 2, 3, or 4 whole numbers.                            |
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Rectangle <sub/rectangle>`                      | A rectangle with floating-point position and size.              |
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Integer Rectangle <sub/rectangle_int>`          | A rectangle with integer position and size.                     |
+-------------------------------------------------------+-----------------------------------------------------------------+
| :doc:`Tags <sub/tags>`                                | A reusable set of tags shared across documents.                 |
+-------------------------------------------------------+-----------------------------------------------------------------+
