...
.. note::
   **Tier 1 Support:** The TypeScript code generator provides complete Tier 1 support. This includes full formula execution (interpreter), patching during load, and language idiomatic features.
